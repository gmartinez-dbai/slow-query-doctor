...
- **PostgreSQL** (v0.2.2a1): Slow query parsing from logs, query normalization, anti-pattern detection (5 patterns), static query rewriting suggestions, impact scoring, EXPLAIN plan analysis (🚧 in progress)
...
### ✅ What's Shipped
- **PostgreSQL Analyzer**: Log parsing (plain/CSV/JSON), query normalization, anti-pattern detection (5 patterns), static optimization suggestions, impact scoring, EXPLAIN plan analysis (🚧 in progress)
