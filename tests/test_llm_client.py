...
class TestLLMClientOpenAI:
    ...
    @patch("iqtoolkit_analyzer.llm_client.OpenAI")
    ...
    @patch("iqtoolkit_analyzer.llm_client.OpenAI", None)
...
class TestLLMClientOllama:
    ...
    @patch("iqtoolkit_analyzer.llm_client.ollama")
    ...
    @patch("iqtoolkit_analyzer.llm_client.ollama", None)
